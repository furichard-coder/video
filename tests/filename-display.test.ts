...
describe("filename display priority", () => {
  it("prioritizes the trailing time or sequence when neighboring prefixes and dates match", () => {
    expect(filenameDisplayPriority("VID_20260718_105000_002.MOV", ["VID_20260718_104425_001.MOV", "VID_20260718_105329_003.MOV"])).toBe("END");
  ...
  it("keeps the beginning visible when English prefixes, years, or dates differ", () => {
    expect(filenameDisplayPriority("VID_20260718_105000.MOV", ["DJI_20260718_104425.MOV", "VID_20260718_105329.MOV"])).toBe("START");
    expect(filenameDisplayPriority("VID_20260718_105000.MOV", ["VID_20260717_104425.MOV", "VID_20260718_105329.MOV"])).toBe("START");
    expect(filenameDisplayPriority("VID_20260718_105000.MOV", ["VID_2025_104425.MOV", "VID_20260718_105329.MOV"])).toBe("START");
  });
