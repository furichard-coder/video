...
const input = { topic: { topic: "森林", locations: ["河內"], storySummary: "保育", audiencePromise: "認識地方" }, durationMs: 30_000, timelineSummary: [], candidates: [{ candidateId: "thumbnail-1", assetId: "a", sourceTimeMs: 0, sourceFileName: "a.mp4", framePath: "C:\\frame.jpg" }, { candidateId: "thumbnail-2", assetId: "b", sourceTimeMs: 10_000, sourceFileName: "b.mp4", framePath: "C:\\frame2.jpg" }, { candidateId: "thumbnail-3", assetId: "c", sourceTimeMs: 20_000, sourceFileName: "c.mp4", framePath: "C:\\frame3.jpg" }] };
